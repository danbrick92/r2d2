class Config:
    serial_readers = {
        "arduino_mock_serial_reader": {
            "fqcn": "r2d2.serial_readers.arduino_mock_serial_reader.ArduinoMockSerialReader",
            "kwargs": {}
        },
        # "arduino_serial_reader": {
        #     "fqcn": "r2d2.serial_readers.arduino_serial_reader.ArduinoSerialReader",
        #     "kwargs": {}
        # }
    }
